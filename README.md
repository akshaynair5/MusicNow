...
##Searching for songs with the search bar - 
...
##Adding songs to the favorite songs list - 
...
###
Creating new playlist and adding a song into it - 
...
The user data and preferences are stored using the localStorage.It is used to store the user playlist,Favorites and playlist. Which are all stored within different States.Hence upon refreshing or closing the website no data is lost.
